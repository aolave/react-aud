    ...
    $.extend(Fastselect.prototype, {
        ...
        init: function(inputElement, options) {
            ...
            this.options = pickTo($.extend(true, {}, Fastselect.defaults, options, {
                ...
                placeholder2: this.$input.attr('placeholder2'),
            }), this.$input.data(), [
                'url', 'loadOnce', 'apiParam', 'initialValue', 'userOptionAllowed', 'parseItem'
            ]);
        ...
        addChoiceItem: function(optionModel) {
            ...
            if(this.options.parseItem){
                if($.isFunction(this.options.parseItem)){
                    optionModel = this.options.parseItem(optionModel)
                }else{
                    optionModel = window[this.options.parseItem](optionModel)
                }
            }

            $(
                '<div data-text="' + optionModel.text + '" data-value="' + optionModel.value + '" class="' + this.options.choiceItemClass + '" ' + (optionModel.title ? '" title="' + optionModel.title + '"' : '' ) + '>' +
        ...
        adjustQueryInputLayout: function() {
            ...
            if (this.isMultiple && this.$queryInput) {
                ...
                if (noneSelected) {
                    ...
                    this.$queryInput.attr('placeholder', this.options.placeholder2).css('width', this.$fakeInput.insertAfter(this.$queryInput).width() + 20);
